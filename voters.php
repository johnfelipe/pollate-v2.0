...
<div class="pl-main pl-body-voters">
		<div class="pl-box">
				<h3 class="pl-tile">
					<?=$lang['questions']['pg-votes']?>
					<small><?=db_unserialize([db_get('questions', 'statistics', $id), 'votes'])?></small>
				</h3>
				<h3 class="pl-tile2">
				...
				<ul class="pl-voters">
						...
						$sql = db_select([
								...
								'where'  => 't.question = "'.$id.'" && t.author != 0 && u.moderat = 0 && u.trash = 0',
		...
		<?=pl_pagination("votes WHERE question = '{$id}' && author != 0", $limit, path."/voters.php?id={$id}&title={$title}&");?>
</div><!-- End Main -->
